...
const CenterColumnTitle = ({sectionContent}) => {

    return (
        <div className={"mx-8 md:mx-16 my-20 flex justify-center"}>
            <div className={"w-full max-w-[700px] flex flex-col items-center gap-3"}>
                <SimpleAnimation styles={"flex flex-col items-center gap-3"}>
...
export default CenterColumnTitle